                        ...
                        <div class="col-lg-6 mx-auto">
                            <div class="auth">
                                ...
                                <div class="auth__form"> 
                                        <div class="mb-3">
                                      <a href="./addUser.html">  <button class="btn auth__btn auth__login" type="submit">ADD USER</button></a>    
                                        </div>
                                        <div class="mb-3">
                                            <button class="btn auth__btn auth__login" type="submit">UPDATE USER</button>
                                        </div>  
                                        <div class="mb-3">
                                        <a href="./Remove.html"> <button class="btn auth__btn auth__login" type="submit">Romove</button></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
window.customElements.define('custom-manage', manageUser);